...
class XLWidget(QWidget):
    ...
    def initialize_gui(self):
        ...
        self.infoLabel.setFixedWidth(700)
        self.infoLabel.setFixedHeight(50)
        self.infoLabel.move(50, 10)

        self.SelectXL = QPushButton(self)
        self.SelectXL.setText("Find Excel file")
        self.SelectXL.setFixedWidth(700)
        self.SelectXL.setFixedHeight(475)
        self.SelectXL.move(50, 75)

        self.SelectXL.clicked.connect(self.openXL)

    def processXL(self, file):
        wb = None
        ...
        try:
            ...
            self.infoLabel.setText('File "' + wbname + '" was not found. Check your spelling and capitalization and try again.')
            return
        ...
        newwbname = wbname[:wbname.rfind('.xlsx')] + '_orderedbyASINs' + ".xlsx"
        try:
            newwb.save(newwbname)
            newwbname = wbname[wbname.rfind("/") + 1:]
        except PermissionError:
            self.infoLabel.setText('Please close ' + newwbname + ', then try again.')
            return

        self.infoLabel.setText("File found. Excel workbook created and named " + newwbname)
